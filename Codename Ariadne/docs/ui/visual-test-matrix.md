...
| M16 | `/settings/privacy?fixture=standard&capture=1` | Auto-lock, retention, redaction, local AI, connector, telemetry-default-off and motion controls | `M16-settings-privacy__1440x900.png` | `M16-settings-privacy__1728x1117.png` | `M16-settings-privacy__1100x800.png` |
